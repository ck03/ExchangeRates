...
class ExchangeRates():
    ...
    def run(self):
        ...
        today = dt.date.today()
        # print(today)
        # print(self.chagedate(str(today)))
        # print(self.next_date_int)
        # print(self.end_date_int)
        if self.end_date_int > self.chagedate(str(today)):
            self.end_date_int = self.chagedate(str(today))
        # print(self.next_date_int, self.end_date_int)
        # return
        next_temp_date = ""
        if self.next_date_int <= self.end_date_int:
            while True:
                if self.next_date_int != self.chagedate(str(today)):
